...
function ReviewerOverview() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value:
        assignedDocuments.filter((doc) => doc.reviewStatus === "pending")
          .length || 0,
      icon: Clock,
      color: "bg-yellow-500",
    ...
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Review assigned documents and provide quality assessments for
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex space-x-2">
                      <span
                        className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium capitalize ${getPriorityBadge(
                          doc.priority || "medium"
                        )}`}
                      >
                        {doc.priority || "Medium"}
      ...
      <div className="mt-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {assignedDocuments
              .filter(
                (doc) => doc.dueDate && new Date(doc.dueDate) > new Date()
              )
