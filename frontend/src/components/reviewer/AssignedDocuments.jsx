...
function AssignedDocuments() {
  ...
  const startReview = async (documentId) => {
    try {
      await axios.post(`/api/reviews/start/${documentId}`);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Assigned Documents</h1>
        <p className="text-gray-600">Documents assigned to you for review</p>
      </div>
        ...
        {assignedDocuments.map((document) => (
          ...
          >
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-sm text-gray-900">
                    {document.dueDates?.review
                      ? new Date(document.dueDates.review).toLocaleDateString()
                      : "Not set"}
                  </p>
                  {document.dueDates?.review && (
                    <span
                    ...
                    >
                      {getDaysLeft(document.dueDates.review)}
                    </span>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {(document.fileInfo?.fileSize / 1024 / 1024).toFixed(2)} MB
                </p>
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              ...
              <button
                onClick={() => startReview(document._id)}
